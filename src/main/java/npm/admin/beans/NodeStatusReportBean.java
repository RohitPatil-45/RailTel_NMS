...
public class NodeStatusReportBean {
	...
	public String getVIEW_NOTES() {
		return VIEW_NOTES;
	}

	public void setVIEW_NOTES(String vIEW_NOTES) {
	...
	public String toString() {
		return "NodeStatusReportBean [ID=" + ID + ", NODE_IP=" + NODE_IP + ", NODE_STATUS=" + NODE_STATUS
				...
				+ DISTRICT + ", LOCATION=" + LOCATION + ", ADD_NOTES=" + ADD_NOTES + ", VIEW_NOTES=" + VIEW_NOTES + "]";
	}
