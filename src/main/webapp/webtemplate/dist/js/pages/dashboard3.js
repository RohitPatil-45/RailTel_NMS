		...
		success: function(data) {
			...
			var salesChart = new Chart($salesChart, {
				...
				data: {
					...
					datasets: [
						{
							backgroundColor: '#28a745', // Green for upArray
							borderColor: '#28a745',    // Green for upArray
							data: data[0]["upArray"],
						},
						{
							backgroundColor: '#dc3545', // Red for downArray
							borderColor: '#dc3545',    // Red for downArray
