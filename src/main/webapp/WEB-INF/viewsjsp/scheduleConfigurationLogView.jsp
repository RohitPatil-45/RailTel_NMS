...
<title>Schedule Configuration Log | DataTables</title>
...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Schedule Configuration Logs</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">View Schedule
									Configuration Log</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Schedule Configuration Log</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="pc" items="${scheduleFetchData}">
												<tr>
													<td>${pc.ID}</td>
													<td>${pc.backuppath}</td>
													<td>${pc.backupSchedule}</td>
													<td>${pc.configType}</td>
													<td>${pc.datepicker}</td>
													<td>${pc.node_ip}</td>
													<td>${pc.stutus}</td>
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/ScheduleConfigurationLog.js"></script>
