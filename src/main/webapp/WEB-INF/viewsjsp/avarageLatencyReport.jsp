...
<html lang="en">
<head>
<title>Avarage Latency Report | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Avarage Latency Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Avarage Latency Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="avarageLatencyReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
