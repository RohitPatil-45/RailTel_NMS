...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Auto Topology History</li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<form method="post" action="autoTopologyHistoryData">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/autoTopologyHistory.js"></script>
