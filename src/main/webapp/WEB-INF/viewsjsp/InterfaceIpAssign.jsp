...
<html lang="en">
<head>
<title>Interface IP Assign</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Interface IP Assign</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Interface IP Assign</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputEmail1">Interface IP</label>
													<!--  <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">-->
													<input id="Interface_ip" name="Interface_ip"
														placeholder="Enter Interface IP" type="text"
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Assigned IP Data</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
