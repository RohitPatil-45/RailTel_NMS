						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/interfaceReport/bandwidthThresholdHistoryForm">Bandwidth
										Threshold History Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Bandwidth Threshold History Report</h3>
