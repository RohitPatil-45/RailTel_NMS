...
<html lang="en">
<head>
<title>Interface Availability Average Graph | DataTables</title>
...
<body class="hold-transition layout-top-nav">
	...
	<div class="wrapper">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Interface Availability Average
										Graph</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
		...
		<div class="card card-default" id="graphView" style="display: none">
			<div class="card-header">
				<h3 class="card-title">Interface Availability Average Graph</h3>
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/barGraphInterfaceAvailablity.js"></script>
