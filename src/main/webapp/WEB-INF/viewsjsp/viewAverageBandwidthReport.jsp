...
<title>Average Bandwidth Report</title>
...
<body class="hold-transition layout-top-nav">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/interfaceReport/bandwidthThresholdHistoryForm">Average
										Bandwidth Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Average Bandwidth Report</h3>
									...
									<table id="example1" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th>Out Traffic(Byte)</th>
												<th>In Traffic(Byte)</th>
	...
	interfaceBandwidthHistoryView.jsp
