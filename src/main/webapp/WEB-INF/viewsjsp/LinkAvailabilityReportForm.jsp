...
<html lang="en">
<head>
<title>Link Availability Report | DataTables</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<h1>Link Availability Report - Working Hours Report</h1>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Link Availability Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Link Availability Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="LinkAvailabilityReportView">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
