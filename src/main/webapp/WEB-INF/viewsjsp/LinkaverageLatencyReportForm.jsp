...
<html lang="en">
<head>
<title>Link average Latency Report | DataTables</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<h1>Link average Latency Report - Working Hours Report</h1>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Link average Latency
									Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Link average Latency Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="LinkaverageLatencyReportView">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>Select Status: </label> <select id="satusselect"
														name="satusselect" class="form-control select2"
														style="width: 100%;">
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/latencyinterfaceformjs.js"></script>
