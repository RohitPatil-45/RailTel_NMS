...
<title>Push Configuration Log | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">View Push Configuration
									Log</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Push Configuration Log</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="pc" items="${pushConfigurationData}">
												<tr>
													<td>${pc.id}</td>
													<td>${pc.templateName}</td>
													<td>${pc.command}</td>
													<td>${pc.op}</td>
													<td>${pc.ip_address}</td>
													<td>${pc.status}</td>
