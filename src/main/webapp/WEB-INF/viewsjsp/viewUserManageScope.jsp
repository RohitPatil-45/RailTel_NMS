...
<title>User Manage Scope Data</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>User Manage Scope</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">User Manage Scope</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">User Manage Scope</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											<c:forEach var="emp" items="${userData}">
												<tr>
													...
													<td><a
														href="javascript:deleteUserManageScope(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
