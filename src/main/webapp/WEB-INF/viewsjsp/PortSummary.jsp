...
<title>Port Summary Report | DataTables</title>
...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Port Summary</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Port Summary</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Port Summary</h4>
	...
	<script src="<%=request.getContextPath()%>/custom_js/portSummary.js"></script>
