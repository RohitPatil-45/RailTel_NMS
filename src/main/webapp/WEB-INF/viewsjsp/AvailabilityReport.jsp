...
<html lang="en">
<head>
<title>Availability Report | DataTables</title>
...
<body class="hold-transition layout-top-nav">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<h1>Average Availability Report</h1>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Average Availability
									Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Average Availability Report</h3>
								</div>

								<form method="POST" action="getAverageAvailabilityReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/AvailabilityReport.js"></script>
