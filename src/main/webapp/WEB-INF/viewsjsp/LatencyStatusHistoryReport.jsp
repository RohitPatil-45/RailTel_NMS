...
<html lang="en">
<head>
<title>Device Latency History Report | DataTables</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<h1>Device Latency History Report - Working Hours Report</h1>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Device Latency History Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="latencyStatusHistoryReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
