...
<html lang="en">
<head>
<title>Syslog Report | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Syslog Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Syslog Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="syslogReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<label for="exampleInputEmail1">Node IP</label>
													<form:select type="text" path="ip" id="ip" name="ip"
														class="form-control select2" style="width: 100%;"
														placeholder="Enter the IP" items="${ip}" />
												</div>
											</div>
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script src="<%=request.getContextPath()%>/custom_js/syslog.js"></script>
