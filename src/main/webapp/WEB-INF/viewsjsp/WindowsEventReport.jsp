...
<html lang="en">
<head>
<title>Windows Event Report | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Windows Event</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary" id="reportForm">
								<div class="card-header">
									<h3 class="card-title">Windows Event</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
								...
								<form>
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary"
											onclick="getWindowsEventReport()">Submit</button>
									</div>
								</form>
							</div>
							...
							<div class="card" id="winEvent" style="display: none;">
								<div class="card-header">
									<h3 class="card-title">Windows Event Report</h3>
