...
<html lang="en">
<head>
<title>Interface Uptime Graph | Graphs</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Interface Uptime Graph</li>
            ...
            series: [
                {
                   ...
                   data: ${interfaceUPGraph}.downtimePercent,
                ...
                },
                {
                   ...
                   data: ${interfaceUPGraph}.uptimePercent,
