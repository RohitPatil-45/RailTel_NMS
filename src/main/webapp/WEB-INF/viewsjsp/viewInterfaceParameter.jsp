...
<title>View Interface Parameter | DataTables</title>
...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Interface Parameter</h1>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">View Interface Parameter</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/viewInterfaceParameter.js"></script>
