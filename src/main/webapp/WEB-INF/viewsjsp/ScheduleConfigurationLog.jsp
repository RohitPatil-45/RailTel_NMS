				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<h1>Schedule Configuration Log</h1>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Schedule Configuration
									Log</li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<form method="post" id="scheduleconfigReportForm"
									action="scheduleConfigReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
