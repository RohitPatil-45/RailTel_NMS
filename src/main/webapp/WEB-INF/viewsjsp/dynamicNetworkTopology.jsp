								...
								<div class="card-body">
									...
									<div id="templatemo_container">
										...
										<span class="tooltiptext"
											...
											Alert</span> <span> <!-- 											<input type="button" value="Edit View" onclick="location.href = 'DynamicNetworkTopologyEditTest.jsp'"> -->
											<input type="button" value="Edit View"
											onclick="editTopologyPageCall()">
