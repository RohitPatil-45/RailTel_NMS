		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Subnet Scan</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">View Subnet Scan</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">View Subnet Scan</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${viewSubnetScan}">
												<tr>

													<td>${emp.GROUP_NAME}</td>
													<td>${emp.START_IP}</td>
													<td>${emp.SUBNET_MASK}</td>


													<td><a href="editSubnetScan/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteSubnetScan(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
