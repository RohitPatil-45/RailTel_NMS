...
<html lang="en">
<head>
<title>Push Configuration Logs | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Push Configuration Logs</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Push Configuration Logs</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="pushConfiReport"
									id="pushConfiReportid">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
									...
									<div class="card-footer">
										<button type="submit" id="pushConfiReport"
