...
<html lang="en">
<head>
<title>Latency Graph | Graphs</title>
...
<body class="hold-transition layout-top-nav">
	...
	<div class="wrapper">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Latency Graph</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" id="latencyGraphForm">
									<div class="card-body">
										<div class="row">
		...
		<div class="card card-default" id="graphView" style="display: none">
			...
			<!-- /.card-header -->
			<div class="card-body" id="latencyGraphContainer"></div>
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/LatencyHistoricalGraph.js"></script>
</body>
