...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Check Trace Route</li>
			...
			<section class="content">
				<div class="container-fluid">
						...
						<div class="col-md-8">
							...
							<div class="card card-primary" style="display: none;"
								...
								<div class="card-header">
									<h3 class="card-title">Trace Route</h3>
								</div>
							...
							<div class="card card-primary" id="uploadFile">
								<div class="card-header">
									<h3 class="card-title">Check Trace Route</h3>
								...
								<div class="card-footer">
									<button type="button" class="btn btn-primary"
										onclick="checkTraceRoute()">
										Submit<i style='display: none; margin-left: 10px;'
											id='traceRouteSpinner' class='fa fa-spinner fa-spin'></i>
									</button>
								</div>
					...
					<!-- /.row -->
					<div class="row" id="trace_route_result" style="display: none">
						<div class="col-md-2"></div>
						<div class="col-md-8">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Trace Route Results</h3>
	...
	<script src="<%=request.getContextPath()%>/custom_js/traceRoute.js"></script>
	<script
