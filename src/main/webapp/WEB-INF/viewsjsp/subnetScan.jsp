...
<c:choose>
	<c:when test="${id==null}">
		<title>Subnet Scan | Datatables</title>
	</c:when>
	<c:otherwise>
		<title>Edit Subnet Scan</title>
	</c:otherwise>
</c:choose>
...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<c:choose>
									<c:when test="${id==null}">
										<li class="breadcrumb-item active">Subnet Scan</li>
									</c:when>
									<c:otherwise>
										<li class="breadcrumb-item active">Edit Subnet Scan</li>
									</c:otherwise>
								</c:choose>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<c:choose>
										<c:when test="${id==null}">
											<h3 class="card-title">Subnet Scan</h3>
										</c:when>
										<c:otherwise>
											<h3 class="card-title">Edit Subnet Scan</h3>
										</c:otherwise>
									</c:choose>
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="subnetScanId"
									modelAttribute="nwSubnetScan">
									<div class="card-body">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:select type="text" path="groupName"
														...
														placeholder="Enter the group name" items="${groupName}" />
												</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" name="subnetScan" id="subnetScan"
												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" name="endsubnetScan" id="endsubnetScan"
															class="form-control" data-inputmask="'alias': 'ip'"
															data-mask />
													</div>
													<!-- /.input group -->
	...
	<script src="<%=request.getContextPath()%>/custom_js/subnetScan.js"></script>
	<%-- <script src="<%=request.getContextPath()%>/webtemplate/plugins/inputmask/inputmask.js"></script>
	<script src="<%=request.getContextPath()%>/webtemplate/plugins/inputmask/inputmask.min.js"></script>
	<script src="<%=request.getContextPath()%>/webtemplate/plugins/inputmask/jquery.inputmask.js"></script>
