...
<title>Average Health Report | DataTables</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/nodeReport/nodeHealthHistoryForm">Average
										Health Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Average Health Report</h3>
										...
										<tbody>
											...
											<%-- <c:forEach var="report" items="${statusReportData}">
												<tr>
													...
													<td>${report.TOTAL_MEMORY/1048576}</td>
													<td>${report.USED_MEMORY/1048576}</td>
													<td>${report.FREE_MEMORY/1048576}</td>
