										...
										<tbody>
											<c:forEach var="emp" items="${viewIpScan}">
												<tr>
													...
													<td><a href="editIpScan/${emp.ID}" class="mr-2"><i
															class="fa fa-edit" style="color: green"></i></a> <a
														href="javascript:deleteIpScan(${emp.ID})" class="mr-2"><i
															class="fa fa-trash" style="color: red"></i></a> <a
														href="javascript:discoveryIpScan(${emp.ID},${emp.GROUP_NAME},${emp.END_IP},${emp.END_IP})"
														class="mr-2"><i class="fa fa-search"
