...
<html lang="en">
<head>
<title>Drive Threshold Report | DataTables</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a
									href="<%=request.getContextPath()%>/nodeReport/driveThreshold">Drive
										Threshold</a></li>
			...
			<section class="content">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-12">
							<!-- jquery validation -->
							<div class="card card-primary" id="reportForm">
								<div class="card-header">
									<h3 class="card-title">Drive Threshold</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
								...
								<form>
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary"
											onclick="getDriveThresholdReport()">Submit</button>
									</div>
								</form>
							</div>


							<!-- Windows Event table Data -->
							<div class="card" id="reportDiv" style="display: none;">
								<div class="card-header">
									<h3 class="card-title">Drive Threshold Report</h3>
									&nbsp; &nbsp; &nbsp;<b>From Date :</b> <span id="fDate"></span>
									<b>&nbsp; &nbsp; &nbsp;To Date :</b> <span id="tDate"></span>
