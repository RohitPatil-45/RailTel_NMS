...
<html lang="en">
<head>
<title>Manual Topology | Graphs</title>
...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Manual Topology</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Manual Topology</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form:form method="post" id="manualTopology"
									modelAttribute="addNodeModal">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputEmail1">Source Device IP</label>
													<form:select name="deviceIp" id="sourceDeviceIp"
														type="text" path="deviceIp" class="form-control select2"
														style="width: 100%;" items="${nodeIpList}" />
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Source Interface
														Name</label> <select name="source_interface_name"
														id="source_interface_name" class="form-control"
														style="width: 100%;">
													</select>
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Destination IP</label>
													<form:select name="deviceIp" id="destinationDeviceIp"
														type="text" path="deviceIp" class="form-control select2"
														style="width: 100%;" items="${nodeIpList}" />
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Destination
														Interface Name</label> <select name="destination_interface_name"
														id="destination_interface_name" class="form-control"
														style="width: 100%;">
													</select>
												</div>
											</div>
									...
									<div class="card-footer" style="display: flex;">
										<button type="submit" id="manualTopologyId"
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/manualTopologyForm.js"></script>
