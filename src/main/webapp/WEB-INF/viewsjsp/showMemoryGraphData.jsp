...
<html lang="en">
<head>
<title>Memory Utilization Graph | Graphs</title>
		...
		<div class="content-wrapper" id="graphFormDiv">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Memory Utilization Graph</li>
			...
			<section>
				...
				<div class="card card-default" id="graphView">
					...
					<!-- /.card-header -->
					<div class="card-body" id="memoryChart"></div>
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script type="text/javascript">
		if(${memoryGraphData}){
		 ...
		 Highcharts.stockChart('memoryChart', {
		        chart: {
		            events: {
		                load: function () {
		                    this.setTitle(null, {
		                        text: 'Free & Used Memory'
		                    });
		                }
		            },
		            zoomType: 'x',
		        ...
		        series: [{
		            name: 'Free Memory',
		            data: ${memoryGraphData}.map(point => [point.Free_RAM]),
		            showInNavigator: true,
		            tooltip: {
		                valueDecimals: 10, // Set the appropriate number of decimal places
		                valueSuffix: 'MB'
		            }
		        }, {
		            name: 'Used Memory',
		            data:${memoryGraphData}.map(point => [point.Used_RAM]),
		            showInNavigator: true,
		            tooltip: {
		                valueDecimals: 10, // Set the appropriate number of decimal places
		                valueSuffix: 'MB'
