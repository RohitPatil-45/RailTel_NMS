						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/nodeReport/latencyHistoryReportForm">Link
										AVG Bandwidth Report</a></li>
									...
									<table id="example1" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th>Device Name</th>
												<th>Group Name</th>
												<th>Average In Traffic(Kbps)</th>
												<th>Average Out Traffic(Kbps)</th>
