...
<title>Interface wise Summary Report | DataTables</title>
...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Interface wise Summary</li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/interfaceSummary.js"></script>
