									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputEmail1">Procured Bandwidth</label>
													<!--  <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">-->
													<form:input type="text" path="Procured_Bandwidth"
														class="form-control" placeholder="Enter Procured Bandwidth" />
												</div>
